# Postulación  nimble-gravity

Mini aplicación en React que se conecta a la API de Nimble Gravity.
...
En la parte "Enviar tu postulación" tambien se agrego el campo applicationId ya que era requerido, este es obtenido en el Step 2.
